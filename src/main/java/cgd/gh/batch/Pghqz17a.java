 ...
 * 
 */
public abstract class Pghqz17a extends CgdGhBaseBatch {
    /**
     * Handled Tables
     */
    /**
     ...
     */
    @Handler(name="FWK900", record="fwk900RegPghqz17a")
    @Data
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHQZ17A");
    ...
    protected void a14000AbrirFwk900() {
        ...
        if (!fwk900().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - FWK900 - OPEN - ");
    ...
    protected void a15000LerFwk900() {
        ...
        fwk900().read() ;
        if (fwk900().getStatusOk()) {
            auxContRegLidos.set(fwk900().fwk900RegPghqz17a().fwk900NCommit());
            fwk900().close() ;
        ...
        if (fwk900().getStatusOk()) {
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - FWK900 - READ - ");
            tabelaImpressao().linha09().impStatus().set(fwk900().getStatus());
        }
    }
    ...
    protected void a15100TratarOutputFwk900() {
        ...
        fwk900().open(CREATE ) ;
        if (fwk900().getStatusOk()) {
            fwk900().fwk900RegPghqz17a().initialize() ;
            fwk900().fwk900RegPghqz17a().fwk900NCommit().set(0);
            auxContRegLidos.set(0);
            fwk900().write(fwk900().fwk900RegPghqz17a()) ;
            if (fwk900().getStatusOk()) {
                fwk900().close() ;
            } else {
                setReturnCode(16) ;
                progStatus.set(16);
                tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - FWK900 - WRITE- ");
                tabelaImpressao().linha09().impStatus().set(fwk900().getStatus());
            }
        } else {
            setReturnCode(16) ;
    ...
    protected void a16000AbrirInput1() {
        ...
        if (!input1().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - INPUT1 - OPEN - ");
    ...
    protected void a17000LerInput1() {
        ...
        if (!input1().getStatusOk() && !input1().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - INPUT1 - READ - ");
            tabelaImpressao().linha09().impStatus().set(input1().getStatus());
        }
    }
    ...
    protected void s70000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha08().impMens1().set("PGHQZ17A - FIM ANORMAL ");
    ...
    protected void a31300ActRegContiphst() {
        ...
        wsVgh01001().wsVgh01001NmRecurso().set("GHSA2000");
        wTimestamp().set(bghr0021().rgh00201().fgh002TsMovimento());
        ...
        switch (hv01001Contiphst().getPersistenceCode()) {
            ...
            default :
                ...
                setReturnCode(16) ;
                progStatus.set(16);
                tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - UPD C1 - VGH01001 - ");
    ...
    protected void a31400InsRegContiphst() {
        ...
        hv01001Contiphst().contiphst().nmRecurso().set("GHSA2000");
         ...
         */
        hv01001Contiphst().insertPghqz17a964() ;
        if (hv01001Contiphst().getPersistenceCode() == PersistenceCode.NORMAL) {
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ17A - INSERT- VGH01001 - ");
            tabelaImpressao().linha09().impStatus().set(wSqlcode);
    ...
    protected void a36100EscreverFwk900() {
        ...
        if (progOk.isTrue()) {
            fwk900().fwk900RegPghqz17a().initialize() ;
            fwk900().fwk900RegPghqz17a().fwk900NCommit().set(add(fwk900().fwk900RegPghqz17a().fwk900NCommit(), contRegCommit));
            fwk900().rewrite(fwk900().fwk900RegPghqz17a()) ;
            if (!fwk900().getStatusOk()) {
                setReturnCode(16) ;
                progStatus.set(16);
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHQZ17A")
            IString filler002() ;
