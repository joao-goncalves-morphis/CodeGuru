 ...
 * OBJECTIVO     : ACTIVA   TRANSACCOES NA ARQUITECTURA ALNOVA
 * 
 * @version 2.0
 * 
 */
public abstract class Pghc109a extends CgdGhBaseBatch {
    /**
     * Handled Files
     */
    /**
     ...
     */
    @Handler(name="SYSIN", record="statusFgh110")
    @Data
    ...
    protected void a00001AbrirFgh110() {
        ...
        if (!fgh110().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha07().msgStatus().set("PGHC109A - FGH110 - OPEN - ");
    ...
    protected void a00002LerFgh110() {
        ...
        if (fgh110().getStatusOk()) {
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha07().msgStatus().set("PGHC109A - FGH110 - READ - ");
            tabelaImpressao().linha07().impStatus().set(fgh110().getStatus());
        }
    }
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHC109A");
    ...
    protected void a31000InactivaTrn1() {
        ...
        hrMhyq150a().bhyl150a().commarea().dadosInput().iAtvzDtvzActiva().setTrue() ;
        ...
        if (!hrMhyq150a().bhyl150a().commarea().dadosOutput().semErros().isTrue()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha07().msgStatus().get(1, 21).set("PGHC109A - MHYQ150A -") ;
    ...
    protected void s70000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha06().impMens1().set("PGHC109A - FIM ANORMAL ");
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHC109A")
            IString filler002() ;
