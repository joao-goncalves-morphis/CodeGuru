 ...
 * 
 */
public abstract class Pghc172a extends CgdGhBaseBatch {
    /**
     * Handled Files
     */
    /**
    ...
    /**
     * @return instancia da classe Fwk00503
     */
    @Handler(name="FWK005", record="statusFwk005")
    @Data
    protected abstract Fwk00503 ficheiroFwk005() ;
    
    /**
     * @return instancia da classe Fgh172
     */
    @Handler(name="FGH172", record="regFgh172400")
    @Data
    protected abstract Fgh172 ficheiroFgh172() ;
    ...
    /**
     * STATUS
     * INICIO WORKING-STORAGE PGHC172A
     * @return instancia da classe local SwStatus
     */
    @Data
    protected abstract SwStatus swStatus() ;
    
    protected static final String CON_FWK005 = "FWK005" ;
    
    protected static final String CON_FGH172 = "FGH172" ;
    
    protected static final String CON_NOME_PROGRAMA = "PGHC172A" ;
     ...
     * 
     */
    protected void m1510OpenFwk005() {
        log(TraceLevel.Debug, "1510-OPEN-FWK005");
        /**
         * \* ABRE FICHEIRO DE INPUT - FWK005
         */
        ficheiroFwk005().open() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swOpenIn().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FWK005);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFwk005().getStatus());
        bhop0013FormataAcesso() ;
        if (!ficheiroFwk005().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().openInput().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK005);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk005().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1510-OPEN-FWK005");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m1520OpenFgh172() {
        log(TraceLevel.Debug, "1520-OPEN-FGH172");
        /**
         * \* ABRE FICHEIRO DE OUTPUT - FGH172
         */
        ficheiroFgh172().open(CREATE ) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swOpenOut().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FGH172);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFgh172().getStatus());
        bhop0013FormataAcesso() ;
        if (!ficheiroFgh172().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().openOutput().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FGH172);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFgh172().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1520-OPEN-FGH172");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m1540ReadFwk005() {
        log(TraceLevel.Debug, "1540-READ-FWK005");
        ficheiroFwk005().read(bghr1702().registo()) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swReadSeq().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FWK005);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFwk005().getStatus());
        bhop0013FormataAcesso() ;
        if (ficheiroFwk005().getStatusOk()) {
            wsVariaveis().wsLidosFwk005().add(CON_N1);
        } else if (!ficheiroFwk005().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().readSequential().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK005);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk005().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1540-READ-FWK005");
            m9900Abend() ;
        }
    }
    ...
    protected void m2000ProcPrograma() {
        ...
        m2300EscreveOutput() ;
        m1540ReadFwk005() ;
        while (!ficheiroFwk005().getStatusOk()) {
            m2200FormataDetalhe() ;
        }
    }
     ...
     * 
     * 2100-FORMATA-HEADER
     * DESC: FORMATACAO DO CABECALHO DO FICHEIRO V11
     * 
     */
    protected void m2100FormataHeader() {
        ...
        bghr1702().registo().header().cIdFichV101().setTrue() ;
        /**
         * GH1303 - INICIO
    ...
    protected void m2200FormataDetalhe() {
        ...
        /**
         * EXCLUIR MOVIMENTOS DO TIPO VERS
         */
        if (!bghr1702().registo().detalheV11().cTipPagmtoVersV11().isTrue()) {
            m2300EscreveOutput() ;
        }
        m1540ReadFwk005() ;
    }
    ...
    protected void m2300EscreveOutput() {
        ...
        ficheiroFgh172().write(ficheiroFgh172().regFgh172400) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        ...
        if (!ficheiroFgh172().getStatusOk()) {
            ...
            wsVariaveis().wsEscritFgh172().add(1);
        }
    }
     ...
     * 
     */
    protected void m3110CloseFwk005() {
        log(TraceLevel.Debug, "3110-CLOSE-FWK005");
        ficheiroFwk005().close() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        ...
        if (!ficheiroFwk005().getStatusOk()) {
            ...
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK005);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk005().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("3110-CLOSE-FWK005");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m3120CloseFgh172() {
        log(TraceLevel.Debug, "3120-CLOSE-FGH172");
        ficheiroFgh172().close() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swCloseFich().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FGH172);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFgh172().getStatus());
        ...
        if (!ficheiroFgh172().getStatusOk()) {
            ...
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FGH172);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFgh172().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("3120-CLOSE-FGH172");
            m9900Abend() ;
        }
    }
    ...
    public interface SwStatus extends IDataStruct {
        ...
        @Data(size=2, value="00")
        IString statusFwk005() ;
        @Data
        @Condition("00")
        ICondition swFwk005Ok() ;
        @Data
        @Condition("10")
        ICondition swFwk005Eof() ;
        
        
        @Data(size=2, value="00")
        IString statusFgh172() ;
        @Data
        @Condition("00")
        ICondition swFgh172Ok() ;
        @Data
        @Condition("10")
        ICondition swFgh172Eof() ;
