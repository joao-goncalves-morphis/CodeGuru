 ...
 * - TGH00010_CONTIPHST
 * FICHEIROS     : FWK007, FWK047, FWK087, FWK127, FWK167,
 * FWK207, FWK247, FWK287, FWK327, FWK367
 * FWK407, FWK447, FWK487.
 ...
 * 
 */
public abstract class Pghqz07a extends CgdGhBaseBatch {
    /**
     * Handled Tables
     */
    /**
     ...
     */
    @Handler(name="FWK900", record="fwk900RegPghqz07a")
    @Data
    ...
    protected void a15000LerFwk900() {
        ...
        fwk900().read() ;
        if (fwk900().getStatusOk()) {
            auxContRegLidos.set(fwk900().fwk900RegPghqz07a().fwk900NCommit());
            fwk900().close() ;
    ...
    protected void a15100TratarOutputFwk900() {
        ...
        fwk900().open(CREATE ) ;
        if (fwk900().getStatusOk()) {
            fwk900().fwk900RegPghqz07a().initialize() ;
            fwk900().fwk900RegPghqz07a().fwk900NCommit().set(0);
            auxContRegLidos.set(0);
            fwk900().write(fwk900().fwk900RegPghqz07a()) ;
            if (fwk900().getStatusOk()) {
                fwk900().close() ;
            } else {
                setReturnCode(16) ;
    ...
    protected void a31300ActRegContiphst() {
        ...
        wsVgh01001().wsVgh01001NmRecurso().set("VGH02501");
        wTimestamp().set(bghr0021().rgh00201().fgh002TsMovimento());
    ...
    protected void a31400InsRegContiphst() {
        ...
        hv01001Contiphst().contiphst().nmRecurso().set("VGH02501");
         ...
         */
        hv01001Contiphst().insertPghqz07a966() ;
    ...
    protected void a36100EscreverFwk900() {
        ...
        if (progOk.isTrue()) {
            fwk900().fwk900RegPghqz07a().initialize() ;
            fwk900().fwk900RegPghqz07a().fwk900NCommit().set(add(fwk900().fwk900RegPghqz07a().fwk900NCommit(), contRegCommit));
            fwk900().rewrite(fwk900().fwk900RegPghqz07a()) ;
            if (!fwk900().getStatusOk()) {
                setReturnCode(16) ;
                progStatus.set(16);
