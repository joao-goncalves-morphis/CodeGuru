 ...
 * DO FICHEIRO PARA A DCR  -PEDIDO: GH00095-
 * ----->   ESTE PROGRAMA E EXECUTADO SEMPRE QUE EXISTIR O*
 * FICHEIRO FGH595 RECEBIDO POR C.DIRECT
 * 
 * @version 2.0
 * 
 */
public abstract class Pghq506a extends CgdGhBaseBatch {
    /**
     * Handled Tables
     */
    /**
     ...
     */
    /**
     * @return instancia da classe Fgh595
     */
    @Handler(name="FGH595", record="rgh59501")
    @Data
    protected abstract Fgh595 fgh595() ;
    ...
    protected ILong contRegLidosFgh595 ;
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHQ506A");
        progOk.setTrue() ;
     ...
     * 
     */
    protected void a14000AbrirFgh595() {
        log(TraceLevel.Debug, "A14000-ABRIR-FGH595 ");
        fgh595().open() ;
        if (!fgh595().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQ506A - FGH595 - OPEN - ");
            tabelaImpressao().linha09().impStatus().set(fgh595().getStatus());
        }
    }
     ...
     * 
     */
    protected void a15000LerFgh595() {
        log(TraceLevel.Debug, "A15000-LER-FGH595");
        fgh595().read() ;
        if (fgh595().getStatusOk()) {
            contRegLidosFgh595.add(1);
        }
        if (!fgh595().getStatusOk() && !fgh595().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQ506A - FGH595 - READ - ");
            tabelaImpressao().linha09().impStatus().set(fgh595().getStatus());
        }
    }
    ...
    protected void s70000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha05().impFichRead().set("FGH595");
            tabelaImpressao().linha05().impRegRead().set(contRegLidosFgh595);
            a12000EscreverFgh300() ;
            ...
            tabelaImpressao().linha08().impMens1().set("PGHQ506A - FIM ANORMAL ");
    ...
    protected void a31100OpenCursorC1() {
        ...
        hv00101Conthst().conthst().cPaisIsoaCont().set("PT");
        hv00101Conthst().conthst().cBancCont().set(35);
        hv00101Conthst().conthst().cOeEgcCont().set(fgh595().rgh59501().fgh595Balcao());
        hv00101Conthst().conthst().nsRdclCont().set(fgh595().rgh59501().fgh595RadicalConta());
        /**
         * Migration Note:
         * call to extracted method to access (OPEN) cursor C1
         */
        hv00101Conthst().openPghq506a547() ;
        if (hv00101Conthst().getPersistenceCode() != PersistenceCode.NORMAL) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQ506A - CURSOR C1   - OPEN - ");
    ...
    protected void a31200FetchCursorC1() {
         ...
         */
        hv00101Conthst().fetchPghq506a576() ;
        wSqlcode.set(hv00101Conthst().getPersistenceCode());
        if (hv00101Conthst().getPersistenceCode() != PersistenceCode.NORMAL && 
    ...
    protected void a32100FormatarPedido() {
        ...
        hv01501Pedmovhst().pedmovhst().cPedInfOpps().set("GH00095");
        ...
        hv01501Pedmovhst().pedmovhst().cUsidCrix().set("PGHQ506A");
        hv01501Pedmovhst().pedmovhst().cUsidActzUlt().set("PGHQ506A");
    ...
    protected void a32110ValidarPedido() {
         ...
         */
        hv01801Pedinf().selectPghq506a685() ;
        if (hv01801Pedinf().getPersistenceCode() != PersistenceCode.NORMAL) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQ506A - SELECT TGH18 -");
    ...
    protected void a32200InsTabelaPedidos() {
         ...
         */
        hv01501Pedmovhst().insertPghq506a723() ;
        if (hv01501Pedmovhst().getPersistenceCode() == PersistenceCode.NORMAL) {
            contRegEscrtTgh015.add(1);
        } else {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQ506A - INSERT TGH15 -  ");
    ...
    protected void a33000CloseCursorC1() {
         ...
         */
        hv00101Conthst().closePghq506a815() ;
        if (hv00101Conthst().getPersistenceCode() != PersistenceCode.NORMAL) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQ506A - CURSOR C1 -CLOSE - ");
            wSqlcode.set(hv00101Conthst().getPersistenceCode());
            tabelaImpressao().linha09().impStatus().set(wSqlcode);
        }
    }
    ...
    protected void mainProcedure() {
        ...
        s10000Iniciar() ;
        if (progOk.isTrue()) {
            while (!fgh595().getStatusOk() && progOk.isTrue()) {
                s30000Processar() ;
            }
        }
        s70000Fim() ;
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHQ506A")
            IString filler002() ;
