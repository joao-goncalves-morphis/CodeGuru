 ...
 * OBJECTIVOS    : COLOCA A TABELA THO00022 EM 'A'(ACTIVA)
 * SIGNIFICA QUE AS CONSULTAS DOS MOVIMENTOS DO
 * DIA ANTERIOR DEVEM SER OBTIDOS DA TABELA
 * TGH00022
 * - ESTE PROGRAMA E EXECUTADO APOS O LOAD DA
 * DA TABELA REFERIDA ANTERIORMENTE
 * 
 * @version 2.0
 * 
 */
public abstract class Pghq302a extends CgdGhBaseBatch {
    /**
     * Handled Tables
     */
    /**
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHQ302A");
        wsIEstRcrs.set("A");
        progOk.setTrue() ;
    ...
    protected void s70000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha07().impMens1().set("PGHQ302A - FIM ANORMAL ");
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHQ302A")
            IString filler002() ;
