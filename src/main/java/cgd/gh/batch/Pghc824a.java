 ...
 * OBJECTIVOS    : LE O FICHEIRO FGH124 -RECUPERACAO DA TGH124
 * DO DIA 08-06 PARA RECUPERACAO
 * ALTERACAO     :
 * 
 * @version 2.0
 * 
 */
public abstract class Pghc824a extends CgdGhBaseBatch {
    /**
     * Handled Files
     */
    /**
     * @return instancia da classe Fgh124
     */
    @Handler(name="FGH124", record="rgh10201")
    @Data
    protected abstract Fgh124 fgh124() ;
    
    /**
     * @return instancia da classe Fwk299
     */
    @Handler(name="FWK299", record="fwk299Reg237")
    @Data
    protected abstract Fwk299 fwk299() ;
    
    /**
     * @return instancia da classe Fwk298
     */
    @Handler(name="FWK298", record="fwk298Reg237")
    @Data
    protected abstract Fwk298 fwk298() ;
    ...
    @Data(size=15, signed=true, value="0", compression=COMP3)
    protected ILong contRegEscrtFwk299 ;
    
    @Data(size=15, signed=true, value="0", compression=COMP3)
    protected ILong contRegEscrtFwk298 ;
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHC824A");
        progOk.setTrue() ;
    ...
    protected void a13000AbrirFicheiros() {
        ...
        if (progOk.isTrue()) {
            fwk299().open(CREATE ) ;
            if (!fwk299().getStatusOk()) {
                setReturnCode(16) ;
                progStatus.set(16);
                tabelaImpressao().linha09().msgStatus().set("PGHC824A - FWK299 - OPEN - ");
                tabelaImpressao().linha09().impStatus().set(fwk299().getStatus());
            }
        }
        if (progOk.isTrue()) {
            fwk298().open(CREATE ) ;
            if (!fwk298().getStatusOk()) {
                setReturnCode(16) ;
                progStatus.set(16);
                tabelaImpressao().linha09().msgStatus().set("PGHC824A - FWK298 - OPEN - ");
                tabelaImpressao().linha09().impStatus().set(fwk298().getStatus());
            }
        }
    }
    ...
    protected void s30000Processar() {
        ...
        if (progOk.isTrue()) {
            ...
            if (progOk.isTrue()) {
                while (!fgh124().getStatusOk() && progOk.isTrue()) {
                    a33000TratarFgh124() ;
                }
                if (progOk.isTrue()) {
     ...
     * 
     */
    protected void a31000OpenFgh124() {
        log(TraceLevel.Debug, "A31000-OPEN-FGH124");
        fgh124().open() ;
        if (!fgh124().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FGH124 - OPEN - ");
            tabelaImpressao().linha09().impStatus().set(fgh124().getStatus());
        }
    }
     ...
     * 
     */
    protected void a32000LerFgh124() {
        log(TraceLevel.Debug, "A32000-LER-FGH124");
        fgh124().read() ;
        if (fgh124().getStatusOk()) {
            contRegLidos.add(1);
            wsDataMov.set(fgh124().rgh10201().fgh102TsMovimento().get(1, 10));
        }
        if (!fgh124().getStatusOk() && !fgh124().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FGH124 - READ - ");
            tabelaImpressao().linha09().impStatus().set(fgh124().getStatus());
        }
    }
     ...
     * 
     */
    protected void a33000TratarFgh124() {
        log(TraceLevel.Debug, "A33000-TRATAR-FGH124");
        if (wsDataMovMask().wsAnoMov().isGreater(2007)) {
            ...
            if (fgh124().rgh10201().fgh102CTipoCont().isEqual(50) || 
                fgh124().rgh10201().fgh102CTipoCont().isEqual(5)) {
                contRegEscrt50.add(1);
            } else {
                a33990EscreverFwk299() ;
            }
     ...
     * 
     */
    protected void a33990EscreverFwk299() {
        log(TraceLevel.Debug, "A35100-ESCREVER-FWK299");
        fwk299().fwk299Reg237.initialize() ;
        fwk299().setRecord(fgh124().getRecord()) ;
        fwk299().write(fwk299().fwk299Reg237) ;
        if (fwk299().getStatusOk()) {
            contRegEscrtFwk299.add(1);
        } else {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FWK299 - WRITE ");
            tabelaImpressao().linha09().impStatus().set(fwk299().getStatus());
     ...
     * 
     */
    protected void a33980EscreverFwk298() {
        log(TraceLevel.Debug, "A35100-ESCREVER-FWK298");
        fwk298().fwk298Reg237.initialize() ;
        fwk298().setRecord(fgh124().getRecord()) ;
        fwk298().write(fwk298().fwk298Reg237) ;
        if (fwk298().getStatusOk()) {
            contRegEscrtFwk298.add(1);
        } else {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FWK298 - WRITE ");
            tabelaImpressao().linha09().impStatus().set(fwk298().getStatus());
            tabelaImpressaoMask().zimp().setIndex(9) ;
            a12000EscreverFgh300() ;
        }
    ...
    protected void a48000FecharFicheiros() {
        ...
        if (!fwk299().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FWK299 - CLOSE - ");
            tabelaImpressao().linha09().impStatus().set(fwk299().getStatus());
        }
        fwk298().close() ;
        if (!fwk298().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FWK298 - CLOSE - ");
            tabelaImpressao().linha09().impStatus().set(fwk298().getStatus());
        }
        fgh124().close() ;
        if (!fgh124().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHC824A - FGH124 - CLOSE - ");
            tabelaImpressao().linha09().impStatus().set(fgh124().getStatus());
        }
    }
    ...
    protected void s50000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha05().impRegLidosFgh124().set(contRegLidos);
            ...
            tabelaImpressao().linha06().impFichEsc().set("CT-50-05");
            a12000EscreverFgh300() ;
            ...
            a12000EscreverFgh300() ;
            tabelaImpressaoMask().zimp().setIndex(6) ;
            tabelaImpressao().linha06().impRegEscrt().set(contRegEscrtFwk299);
            tabelaImpressao().linha06().impFichEsc().set("FWK299");
            a12000EscreverFgh300() ;
            tabelaImpressaoMask().zimp().setIndex(6) ;
            tabelaImpressao().linha06().impRegEscrt().set(contRegEscrtFwk298);
            tabelaImpressao().linha06().impFichEsc().set("FWK298");
            a12000EscreverFgh300() ;
            tabelaImpressaoMask().zimp().setIndex(6) ;
            ...
            tabelaImpressao().linha06().impFichEsc().set("A = 1998");
            a12000EscreverFgh300() ;
            tabelaImpressaoMask().zimp().setIndex(6) ;
        } else {
            tabelaImpressao().linha07().impReturnCode().set(returnCode);
            tabelaImpressao().linha08().impMens1().set("PGHC824A - FIM ANORMAL ");
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHC824A")
            IString filler002() ;
        ...
        public interface Linha05 extends IDataStruct {
            ...
            @Data(size=35, value="NUMERO DE REGISTOS LIDOS EM FGH124")
            IString filler002() ;
            ...
            IFormattedString impRegLidosFgh124() ;
