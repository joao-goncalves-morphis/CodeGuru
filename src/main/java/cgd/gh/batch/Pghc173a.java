 ...
 * 
 */
public abstract class Pghc173a extends CgdGhBaseBatch {
    /**
     * Handled Files
     */
    /**
    ...
    /**
     * @return instancia da classe Fwk00703
     */
    @Handler(name="FWK007", record="statusFwk007")
    @Data
    protected abstract Fwk00703 ficheiroFwk007() ;
    
    /**
     * @return instancia da classe Fgh173
     */
    @Handler(name="FGH173", record="regFgh173400")
    @Data
    protected abstract Fgh173 ficheiroFgh173() ;
    ...
    /**
     * STATUS
     * INICIO WORKING-STORAGE PGHC173A
     * @return instancia da classe local SwStatus
     */
    @Data
    protected abstract SwStatus swStatus() ;
    
    protected static final String CON_FWK007 = "FWK007" ;
    
    protected static final String CON_FGH173 = "FGH173" ;
    
    protected static final String CON_NOME_PROGRAMA = "PGHC173A" ;
     ...
     * 
     */
    protected void m1510OpenFwk007() {
        log(TraceLevel.Debug, "1510-OPEN-FWK007");
        /**
         * \* ABRE FICHEIRO DE INPUT - FWK007
         */
        ficheiroFwk007().open() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swOpenIn().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FWK007);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFwk007().getStatus());
        bhop0013FormataAcesso() ;
        if (!ficheiroFwk007().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().openInput().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK007);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk007().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1510-OPEN-FWK007");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m1520OpenFgh173() {
        log(TraceLevel.Debug, "1520-OPEN-FGH173");
        /**
         * \* ABRE FICHEIRO DE OUTPUT - FGH173
         */
        ficheiroFgh173().open(CREATE ) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swOpenOut().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FGH173);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFgh173().getStatus());
        bhop0013FormataAcesso() ;
        if (!ficheiroFgh173().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().openOutput().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FGH173);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFgh173().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1520-OPEN-FGH173");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m1540ReadFwk007() {
        log(TraceLevel.Debug, "1540-READ-FWK007");
        ficheiroFwk007().read(bghr1702().registo()) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swReadSeq().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FWK007);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFwk007().getStatus());
        bhop0013FormataAcesso() ;
        if (ficheiroFwk007().getStatusOk()) {
            wsVariaveis().wsLidosFwk007().add(CON_N1);
        } else if (!ficheiroFwk007().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().readSequential().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK007);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk007().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1540-READ-FWK007");
            m9900Abend() ;
        }
    }
    ...
    protected void m2000ProcPrograma() {
        ...
        m2300EscreveOutput() ;
        m1540ReadFwk007() ;
        while (!ficheiroFwk007().getStatusOk()) {
            m2200FormataDetalhe() ;
        }
    }
     ...
     * 
     * 2100-FORMATA-HEADER
     * DESC: FORMATACAO DO CABECALHO DO FICHEIRO V12
     * 
     */
    protected void m2100FormataHeader() {
        ...
        bghr1702().registo().header().cIdFichV102().setTrue() ;
        /**
         * GH1983 - FIM
         * GH1303 - INICIO
    ...
    protected void m2300EscreveOutput() {
        ...
        ficheiroFgh173().write(ficheiroFgh173().regFgh173400) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        ...
        if (!ficheiroFgh173().getStatusOk()) {
            ...
            wsVariaveis().wsEscritFgh173().add(1);
        }
    }
     ...
     * 
     */
    protected void m3110CloseFwk007() {
        log(TraceLevel.Debug, "3110-CLOSE-FWK007");
        ficheiroFwk007().close() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        ...
        if (!ficheiroFwk007().getStatusOk()) {
            ...
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK007);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk007().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("3110-CLOSE-FWK007");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m3120CloseFgh173() {
        log(TraceLevel.Debug, "3120-CLOSE-FGH173");
        ficheiroFgh173().close() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swCloseFich().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FGH173);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFgh173().getStatus());
        ...
        if (!ficheiroFgh173().getStatusOk()) {
            ...
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FGH173);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFgh173().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("3120-CLOSE-FGH173");
            m9900Abend() ;
        }
    }
    ...
    public interface SwStatus extends IDataStruct {
        ...
        @Data(size=2, value="00")
        IString statusFwk007() ;
        @Data
        @Condition("00")
        ICondition swFwk007Ok() ;
        @Data
        @Condition("10")
        ICondition swFwk007Eof() ;
        
        
        @Data(size=2, value="00")
        IString statusFgh173() ;
        @Data
        @Condition("00")
        ICondition swFgh173Ok() ;
        @Data
        @Condition("10")
        ICondition swFgh173Eof() ;
