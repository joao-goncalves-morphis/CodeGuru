 ...
 * 
 */
public abstract class Pghc174a extends CgdGhBaseBatch {
    /**
     * Handled Files
     */
    /**
    ...
    /**
     * @return instancia da classe Fwk00903
     */
    @Handler(name="FWK009", record="statusFwk009")
    @Data
    protected abstract Fwk00903 ficheiroFwk009() ;
    
    /**
     * @return instancia da classe Fgh174
     */
    @Handler(name="FGH174", record="regFgh174400")
    @Data
    protected abstract Fgh174 ficheiroFgh174() ;
    ...
    /**
     * STATUS
     * INICIO WORKING-STORAGE PGHC174A
     * @return instancia da classe local SwStatus
     */
    @Data
    protected abstract SwStatus swStatus() ;
    
    protected static final String CON_FWK009 = "FWK009" ;
    
    protected static final String CON_FGH174 = "FGH174" ;
    
    protected static final String CON_NOME_PROGRAMA = "PGHC174A" ;
     ...
     * 
     */
    protected void m1510OpenFwk009() {
        log(TraceLevel.Debug, "1510-OPEN-FWK009");
        /**
         * \* ABRE FICHEIRO DE INPUT - FWK009
         */
        ficheiroFwk009().open() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swOpenIn().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FWK009);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFwk009().getStatus());
        bhop0013FormataAcesso() ;
        if (!ficheiroFwk009().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().openInput().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK009);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk009().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1510-OPEN-FWK009");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m1520OpenFgh174() {
        log(TraceLevel.Debug, "1520-OPEN-FGH174");
        /**
         * \* ABRE FICHEIRO DE OUTPUT - FGH174
         */
        ficheiroFgh174().open(CREATE ) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swOpenOut().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FGH174);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFgh174().getStatus());
        bhop0013FormataAcesso() ;
        if (!ficheiroFgh174().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().openOutput().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FGH174);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFgh174().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1520-OPEN-FGH174");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m1540ReadFwk009() {
        log(TraceLevel.Debug, "1540-READ-FWK009");
        ficheiroFwk009().read(bghr1702().registo()) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swReadSeq().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FWK009);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFwk009().getStatus());
        bhop0013FormataAcesso() ;
        if (ficheiroFwk009().getStatusOk()) {
            wsVariaveis().wsLidosFwk009().add(CON_N1);
        } else if (!ficheiroFwk009().getStatusOk()) {
            bhtw0030().dadosEntrada().abendFicheiro().setTrue() ;
            bhtw0033().dadosFicheiros().readSequential().setTrue() ;
            bhtw0030().dadosEntrada().cTipoOpeObjDb2().set(bhtw0033().dadosFicheiros().cTipoOpeFich());
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK009);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk009().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("1540-READ-FWK009");
            m9900Abend() ;
        }
    }
    ...
    protected void m2000ProcPrograma() {
        ...
        m2300EscreveOutput() ;
        m1540ReadFwk009() ;
        while (!ficheiroFwk009().getStatusOk()) {
            m2200FormataDetalhe() ;
        }
    }
     ...
     * 
     * 2100-FORMATA-HEADER
     * DESC: FORMATACAO DO CABECALHO DO FICHEIRO V17
     * 
     */
    protected void m2100FormataHeader() {
        ...
        bghr1702().registo().header().cIdFichV107().setTrue() ;
        /**
         * PLX    - FIM
         * GH1303 - INICIO
    ...
    protected void m2300EscreveOutput() {
        ...
        ficheiroFgh174().write(ficheiroFgh174().regFgh174400) ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        ...
        if (!ficheiroFgh174().getStatusOk()) {
            ...
            wsVariaveis().wsEscritFgh174().add(1);
        }
    }
     ...
     * 
     */
    protected void m3110CloseFwk009() {
        log(TraceLevel.Debug, "3110-CLOSE-FWK009");
        ficheiroFwk009().close() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        ...
        if (!ficheiroFwk009().getStatusOk()) {
            ...
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FWK009);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFwk009().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("3110-CLOSE-FWK009");
            m9900Abend() ;
        }
    }
     ...
     * 
     */
    protected void m3120CloseFgh174() {
        log(TraceLevel.Debug, "3120-CLOSE-FGH174");
        ficheiroFgh174().close() ;
        bhow0013().dadosInput().ficheiro().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().swCloseFich().setTrue() ;
        bhow0013().dadosInput().dadosFicheiro().nmFicheiro().set(CON_FGH174);
        bhow0013().dadosInput().dadosFicheiro().cFsttCobl().set(ficheiroFgh174().getStatus());
        ...
        if (!ficheiroFgh174().getStatusOk()) {
            ...
            bhtw0030().dadosEntrada().nmFicheiro().set(CON_FGH174);
            bhtw0030().dadosEntrada().cFsttCobl().set(ficheiroFgh174().getStatus());
            bhtw0030().dadosEntrada().xSugRtnoSwal().set("3120-CLOSE-FGH174");
            m9900Abend() ;
        }
    }
    ...
    public interface SwStatus extends IDataStruct {
        ...
        @Data(size=2, value="00")
        IString statusFwk009() ;
        @Data
        @Condition("00")
        ICondition swFwk009Ok() ;
        @Data
        @Condition("10")
        ICondition swFwk009Eof() ;
        
        
        @Data(size=2, value="00")
        IString statusFgh174() ;
        @Data
        @Condition("00")
        ICondition swFgh174Ok() ;
        @Data
        @Condition("10")
        ICondition swFgh174Eof() ;
