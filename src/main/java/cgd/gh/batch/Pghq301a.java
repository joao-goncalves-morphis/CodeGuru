 ...
 * OBJECTIVOS    : COLOCA A TABELA THO00022 EM H
 * SIGNIFICA QUE AS CONSULTAS DOS MOVIMENTOS DO
 * DIA ANTERIOR DEVEM SER AINDA PEDIDOS A APLICA
 * CAO HO
 * - ESTE PROGRAMA E EXECUTADO LOGO QUE O FICHEIRO*
 * DE PASSAGEM DOS MOVIMENTOS DOS HO E PASSADO
 * PARA OS GH
 * 
 * @version 2.0
 * 
 */
public abstract class Pghq301a extends CgdGhBaseBatch {
    /**
     * Handled Tables
     */
    /**
    ...
    protected void a31000OpenCursorC1() {
        ...
        if (hv00301Gatcnsmov().getPersistenceCode() != PersistenceCode.NORMAL) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha08().msgStatus().set("PGHQ301A - CURSOR C1   - OPEN - ");
    ...
    protected void a32000FetchCursorC1() {
        ...
        if (hv00301Gatcnsmov().getPersistenceCode() != PersistenceCode.NOTFND && 
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha08().msgStatus().set("PGHQ301A - FETCH C1- VGH00301 - ");
            tabelaImpressao().linha08().impStatus().set(wSqlcode);
    ...
    protected void a33000ActTabela() {
        log(TraceLevel.Debug, "A33000-ACT-TABELA");
        hv00301Gatcnsmov().gatcnsmov().iEstRcrs().set(wsIEstRcrs);
        hv00301Gatcnsmov().gatcnsmov().cUsidActzUlt().set(bghw0300().wsNmPrograma());
        wSqlcode.initialize() ;
        /**
         * Migration Note:
         * call to extracted method to access (UPDATE) table VGH00301_GATCNSMOV
         */
        hv00301Gatcnsmov().updateBghp0003110() ;
        wSqlcode.set(hv00301Gatcnsmov().getPersistenceCode());
        if (hv00301Gatcnsmov().getPersistenceCode() != PersistenceCode.NORMAL) {
            wSqlcode.set(hv00301Gatcnsmov().getPersistenceCode());
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha08().msgStatus().set("PGHQ301A - UPD C1 - VGH00301 - ");
            tabelaImpressao().linha08().impStatus().set(wSqlcode);
        }
    }
    ...
    protected void a34000InsTabela() {
        ...
        if (hv00301Gatcnsmov().getPersistenceCode() != PersistenceCode.NORMAL) {
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha08().msgStatus().set("PGHQ301A - INSERT- VGH00301 - ");
            tabelaImpressao().linha08().impStatus().set(wSqlcode);
            log(TraceLevel.Error, "SQLCODE-", wSqlcode);
            a35000CloseCursorC1() ;
        }
    ...
    protected void a35000CloseCursorC1() {
        log(TraceLevel.Debug, "A35000-CLOSE-CURSOR-C1");
        wSqlcode.initialize() ;
        /**
         * Migration Note:
         * call to extracted method to access (CLOSE) cursor C1
         */
        hv00301Gatcnsmov().closeBghp0003193() ;
        wSqlcode.set(hv00301Gatcnsmov().getPersistenceCode());
        if (hv00301Gatcnsmov().getPersistenceCode() != PersistenceCode.NORMAL) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha08().msgStatus().set("PGHQ301A - CLOSE C1-VGH00301 - ");
            tabelaImpressao().linha08().impStatus().set(wSqlcode);
        }
    }
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHQ301A");
        wsIEstRcrs.set("H");
        progOk.setTrue() ;
    ...
    protected void s70000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha07().impMens1().set("PGHQ301A - FIM ANORMAL ");
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHQ301A")
            IString filler002() ;
        ...
        public interface Linha05 extends IDataStruct {
            ...
            @Data(size=39, value="TABELA TGH00003_GATCNSMOV EM ESTADO -H-")
            IString filler002() ;
