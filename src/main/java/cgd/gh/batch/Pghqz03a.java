 ...
 * 
 */
public abstract class Pghqz03a extends CgdGhBaseBatch {
    /**
     * Handled Tables
     */
    /**
     ...
     */
    @Handler(name="FWK900", record="fwk900RegPghqz03a")
    @Data
    ...
    protected void s10000Iniciar() {
        ...
        bghw0300().wsNmPrograma().set("PGHQZ03A");
    ...
    protected void a14000AbrirFwk900() {
        ...
        if (!fwk900().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - FWK900 - OPEN - ");
    ...
    protected void a15000LerFwk900() {
        ...
        fwk900().read() ;
        if (fwk900().getStatusOk()) {
            auxContRegLidos.set(fwk900().fwk900RegPghqz03a().fwk900NCommit());
            fwk900().close() ;
        ...
        if (fwk900().getStatusOk()) {
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - FWK900 - READ - ");
            tabelaImpressao().linha09().impStatus().set(fwk900().getStatus());
        }
    }
    ...
    protected void a15100TratarOutputFwk900() {
        ...
        fwk900().open(CREATE ) ;
        if (fwk900().getStatusOk()) {
            fwk900().fwk900RegPghqz03a().initialize() ;
            fwk900().fwk900RegPghqz03a().fwk900NCommit().set(0);
            auxContRegLidos.set(0);
            fwk900().write(fwk900().fwk900RegPghqz03a()) ;
            if (fwk900().getStatusOk()) {
                fwk900().close() ;
            } else {
                setReturnCode(16) ;
                progStatus.set(16);
                tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - FWK900 - WRITE- ");
                tabelaImpressao().linha09().impStatus().set(fwk900().getStatus());
            }
        } else {
            setReturnCode(16) ;
    ...
    protected void a16000AbrirInput1() {
        ...
        if (!input1().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - INPUT1 - OPEN - ");
    ...
    protected void a17000LerInput1() {
        ...
        if (!input1().getStatusOk() && !input1().getStatusOk()) {
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - INPUT1 - READ - ");
            tabelaImpressao().linha09().impStatus().set(input1().getStatus());
        }
    }
    ...
    protected void s70000Fim() {
        ...
        if (progOk.isTrue()) {
            ...
            tabelaImpressao().linha08().impMens1().set("PGHQZ03A - FIM ANORMAL ");
     ...
     * END-IF
     * INITIALIZE VGH02301-MOVHIST3
     * MOVE FGH002-C-PAIS-ISOA-CONT    TO VGH02301-C-PAIS-ISOA-CONT
     * MOVE FGH002-C-BANC-CONT         TO VGH02301-C-BANC-CONT
     * MOVE FGH002-C-OE-EGC-CONT       TO VGH02301-C-OE-EGC-CONT
     * MOVE FGH002-NS-RDCL-CONT        TO VGH02301-NS-RDCL-CONT
     * MOVE FGH002-V-CHKD-CONT         TO VGH02301-V-CHKD-CONT
     * MOVE FGH002-C-TIPO-CONT         TO VGH02301-C-TIPO-CONT
     * MOVE FGH002-C-MOED-ISO-SCTA     TO VGH02301-C-MOED-ISO-SCTA
     * MOVE FGH002-NS-DEPOSITO         TO VGH02301-NS-DEPOSITO
     * MOVE FGH002-TS-MOVIMENTO        TO VGH02301-TS-MOVIMENTO
     * MOVE FGH002-NS-MOVIMENTO        TO VGH02301-NS-MOVIMENTO
     * MOVE FGH002-Z-VAL-MOV           TO VGH02301-Z-VAL-MOV
     * MOVE FGH002-Z-MOV-LOCL          TO VGH02301-Z-MOV-LOCL
     * MOVE FGH002-I-DBCR              TO VGH02301-I-DBCR
     * MOVE FGH002-M-MOVIMENTO         TO VGH02301-M-MOVIMENTO
     * MOVE FGH002-I-ESTORNO           TO VGH02301-I-ESTORNO
     * MOVE FGH002-C-MOED-ISO-ORI-MOV
     * TO VGH02301-C-MOED-ISO-ORI-MOV
     * MOVE FGH002-M-SLDO-CBLO-APOS    TO VGH02301-M-SLDO-CBLO-APOS
     * MOVE FGH002-M-SLDO-DPNL-APOS    TO VGH02301-M-SLDO-DPNL-APOS
     * MOVE FGH002-M-MOV-MOE-ORIG-MOV
     * TO VGH02301-M-MOV-MOE-ORIG-MOV
     * MOVE FGH002-X-REF-MOV           TO VGH02301-X-REF-MOV
     * MOVE FGH002-N-DOC-OPPS          TO VGH02301-N-DOC-OPPS
     * MOVE FGH002-A-APL-ORIG          TO VGH02301-A-APL-ORIG
     * MOVE FGH002-I-EXIS-INF-ADI      TO VGH02301-I-EXIS-INF-ADI
     * MOVE FGH002-X-CHAV-ACS-INF-ADI
     * TO VGH02301-X-CHAV-ACS-INF-ADI
     * MOVE FGH002-TS-ACTZ-ULT         TO VGH02301-TS-ACTZ-ULT
     * MOVE FGH002-C-USID-ACTZ-ULT     TO VGH02301-C-USID-ACTZ-ULT
     * EXEC SQL
     * INSERT INTO VGH02301_MOVHIST3
     * C_PAIS_ISOA_CONT     ,
     * C_BANC_CONT          ,
     * C_OE_EGC_CONT        ,
     * NS_RDCL_CONT         ,
     ...
     * C_USID_ACTZ_ULT
     * VALUES
     * :VGH02301-C-PAIS-ISOA-CONT      ,
     * :VGH02301-C-BANC-CONT           ,
     * :VGH02301-C-OE-EGC-CONT         ,
     * :VGH02301-NS-RDCL-CONT          ,
     * :VGH02301-V-CHKD-CONT           ,
     * :VGH02301-C-TIPO-CONT           ,
     * :VGH02301-C-MOED-ISO-SCTA       ,
     * :VGH02301-NS-DEPOSITO           ,
     * :VGH02301-TS-MOVIMENTO          ,
     * :VGH02301-NS-MOVIMENTO          ,
     * :VGH02301-Z-VAL-MOV             ,
     * :VGH02301-Z-MOV-LOCL            ,
     * :VGH02301-I-DBCR                ,
     * :VGH02301-M-MOVIMENTO           ,
     * :VGH02301-I-ESTORNO             ,
     * :VGH02301-C-MOED-ISO-ORI-MOV    ,
     * :VGH02301-M-SLDO-CBLO-APOS      ,
     * :VGH02301-M-SLDO-DPNL-APOS      ,
     * :VGH02301-M-MOV-MOE-ORIG-MOV    ,
     * :VGH02301-X-REF-MOV             ,
     * :VGH02301-N-DOC-OPPS            ,
     * :VGH02301-A-APL-ORIG            ,
     * :VGH02301-I-EXIS-INF-ADI        ,
     * :VGH02301-X-CHAV-ACS-INF-ADI    ,
     * :VGH02301-TS-ACTZ-ULT           ,
     * :VGH02301-C-USID-ACTZ-ULT
     * END-EXEC
     * EVALUATE TRUE
     * WHEN SQLCODE = 0
     * ADD +1               TO CONT-REG-INS-VGH02301
     * WHEN OTHER
     * MOVE +16              TO RETURN-CODE
     * PROG-STATUS
     * MOVE 'PGHQZ03A - VGH02301 - INSERT  - '
     * TO MSG-STATUS
    ...
    protected void a31300ActRegContiphst() {
        ...
        wsVgh01001().wsVgh01001NmRecurso().set("VGH02301");
        wTimestamp().set(bghr0021().rgh00201().fgh002TsMovimento());
        ...
        switch (hv01001Contiphst().getPersistenceCode()) {
            ...
            default :
                ...
                setReturnCode(16) ;
                progStatus.set(16);
                tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - UPD C1 - VGH01001 - ");
    ...
    protected void a31400InsRegContiphst() {
        ...
        hv01001Contiphst().contiphst().nmRecurso().set("VGH02301");
         ...
         */
        hv01001Contiphst().insertPghqz03a960() ;
        if (hv01001Contiphst().getPersistenceCode() == PersistenceCode.NORMAL) {
            ...
            setReturnCode(16) ;
            progStatus.set(16);
            tabelaImpressao().linha09().msgStatus().set("PGHQZ03A - INSERT- VGH01001 - ");
            tabelaImpressao().linha09().impStatus().set(wSqlcode);
    ...
    protected void a36100EscreverFwk900() {
        ...
        if (progOk.isTrue()) {
            fwk900().fwk900RegPghqz03a().initialize() ;
            fwk900().fwk900RegPghqz03a().fwk900NCommit().set(add(fwk900().fwk900RegPghqz03a().fwk900NCommit(), contRegCommit));
            fwk900().rewrite(fwk900().fwk900RegPghqz03a()) ;
            if (!fwk900().getStatusOk()) {
                setReturnCode(16) ;
                progStatus.set(16);
    ...
    public interface TabelaImpressao extends IDataStruct {
        ...
        public interface Linha04 extends IDataStruct {
            ...
            @Data(size=36, value="TEMPO GASTO NA EXECUCAO DE PGHQZ03A")
            IString filler002() ;
