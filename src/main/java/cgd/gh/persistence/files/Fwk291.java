...
import cgd.gh.persistence.files.Fwk20101.RegFwk200.Fwk200FicheiroFgh500 ;
import cgd.gh.persistence.files.Fwk20101.RegFwk200.Fwk200Pedido ;
 ...
 * 
 */
public abstract class Fwk291 extends DataFileHandler {
    
    /**
     * @return instancia da classe local RegFwk291
     */
    @Data
    public abstract RegFwk291 regFwk291() ;
    
    @Data(size=286)
    public IString regFwk291286 ;
    /**
     * Inner Classes
     */
     ...
     * Global
     */
    public interface RegFwk291 extends IDataStruct {
