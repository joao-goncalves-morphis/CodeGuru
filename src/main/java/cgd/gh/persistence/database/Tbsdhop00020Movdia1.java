 ...
 * 
 */
public abstract class Tbsdhop00020Movdia1 extends BaseTableHandler {
    /**
     ...
     * called from Mghs111a.A3121AcedeTho20A3121AcedeTho20
     * 
     */
    public void closeMghs111a434() {
     ...
     */
    public void fetchMghs111a378(ILong pNsMovimento, IString pAAplicacao, IInt pNsJourBbn, IInt pNsJourBbnDtlh) {
        BaseCursorHandler c = getCursor("C2") ;
        c.fetch() ;
     ...
     * @param pNsJourBbnDtlh
     */
    public void fetchMghs111a414(ILong pNsMovimento, IString pAAplicacao, IInt pNsJourBbn, IInt pNsJourBbnDtlh) {
        BaseCursorHandler c = getCursor("C2") ;
        c.fetch() ;
        if (c.getPersistenceCode() == PersistenceCode.NORMAL) {
            pNsMovimento.set(c.getValue("NS_MOVIMENTO")) ;
     ...
     * @param pMovdia1
     */
    public void openMghs111a366(Vwsdhops02001Movdia1.Movdia1 pMovdia1) {
        /**
         * *----------------------------------------------------------------*
         */
        sqlSttmt = "SELECT  " +
