 ...
 * 
 */
public interface Bghm1131 extends IDataStruct {
    ...
    public interface Msg extends IDataStruct {
        ...
        public interface Ade extends IDataStruct {
            ...
            /**
             * 88 BGHM1131-C-TIP-REL-DEP-FAMIL      VALUE 'F'.
             * 88 BGHM1131-C-TIP-REL-DEP-AMIGO      VALUE 'A'.
             * 88 BGHM1131-C-TIP-REL-DEP-CONHE      VALUE 'C'.
             * 88 BGHM1131-C-TIP-REL-DEP-RELCM      VALUE 'R'.
             * 88 BGHM1131-C-TIP-REL-DEP-OUTRO      VALUE 'O'.
             * 88 BGHM1131-C-TIP-REL-DEP-SRELA      VALUE 'S'.
             * 88 BGHM1131-C-TIP-REL-DEP-VALID      VALUE 'F','A','C',
             * 'R','O','S'.
             */
            @Data(size=50)
            IString xInfJstzDep() ;
