 ...
 * 
 */
public interface Bghm1071 extends IDataStruct {
    
    @Data(size=4, signed=true, value="223", compression=COMP)
    IInt qCterCmptAlig() ;
    ...
    public interface Msg extends IDataStruct {
        ...
        public interface Ade extends IDataStruct {
            ...
            /**
             * @return instancia da classe local GrHst
             */
            @Data(length=11)
            IArray<GrHst> grHst() ;
            
            
            public interface GrHst extends IDataStruct {
