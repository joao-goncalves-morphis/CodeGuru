 ...
 * 
 */
public interface Bhow0013 extends IDataStruct {
    ...
    public static final String BHOW0013_CON_TABELA = "T" ;
    
    public static final String BHOW0013_CON_FICHEIRO = "F" ;
    
    public static final String BHOW0013_CON_ROTINA = "R" ;
