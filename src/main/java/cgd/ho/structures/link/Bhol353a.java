 ...
 * 
 */
public interface Bhol353a extends IDataStruct {
    ...
    /**
     * 
     * BHOL353A - AREA DE LIGACAO DA ROTINA HISTORICO DE MOVIMENTOS
     * 
     * @version 2.0
     * 
     */
    public interface Commarea extends IDataStruct {
        ...
        public interface DadosInput extends IDataStruct {
            ...
            @Data(size=15, compression=COMP3)
            ILong nsMovimento() ;
        ...
        public interface DadosOutput extends IDataStruct {
            ...
            @Data(size=11, decimal=6, compression=COMP3)
            IDecimal tCambio() ;
            
            /**
             * INI - HO11253 - 04/05/2010
             */
            @Data(size=26)
            IString tsActzUlt() ;
